    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            ...
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="">HELLO ADMIN</a></span>
            </div>
        </div>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="login.jsp"><span class="mbri-logout mbr-iconfont mbr-iconfont-btn"></span>
                    &nbsp; Log Out</a></div>
        </div>
    </nav>
</section>
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="images/addquiz.jpg" alt="Mobirise" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">ADD QUIZ</h4>
                        <p class="mbr-text mbr-fonts-style display-7"></p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="test_details.html" class="btn btn-primary display-4">&nbsp; &nbsp; &nbsp; &nbsp; ADD &nbsp; &nbsp; &nbsp;&nbsp;</a></div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">QUIZ DETAILS</h4>
                        <p class="mbr-text mbr-fonts-style display-7"></p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="quizDetail.jsp" class="btn btn-primary display-4">View
                        </a></div>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="images/stuDetail.jpg" alt="Mobirise" media-simple="true">
                    </div>
                    <div class="card-box">
                    ...
                    <div class="mbr-section-btn text-center"><a href="studentDetail.jsp" class="btn btn-primary display-4">View
                        </a></div>
                </div>
            </div>
