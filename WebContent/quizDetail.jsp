...
<%
		...
		PreparedStatement pst = con.prepareStatement("select test,subject,count(question) from questions group by test,subject");
		ResultSet rs = pst.executeQuery(),rs1;
		%>
		<div class="container">
		<table class="table table-hover table-bordered">
		<tr class="success"><th>TEST NAME</th><th>SUBJECT NAME</th><th>NO OF QUESTION</th></tr>
		<%while(rs.next())
			{
				%>
